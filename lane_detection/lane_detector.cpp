...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    cv::cvtColor(thresh, detected_lines_img, COLOR_GRAY2BGR);
///////////////////////////////////////////////////////////////////////////////////////////////////////////
    // GpuMat d_src(thresh);
    // GpuMat d_lines;
    // Ptr<cuda::HoughSegmentDetector> hough = cuda::createHoughSegmentDetector(1.0f, (float) (CV_PI / 180.0f), 500, 10, 30);
    ...
    // {
    //     Vec4i l = lines[i];
    //     line(detected_lines_img, Point(l[0], l[1]), Point(l[2], l[3]), Scalar(0, 0, 255), 3, LINE_AA);
    // }
